...
// EmpWage Computation of Multiple Companies.
    ...
    public static void main(String args[])
    {
        ...
        calculateTotalWage("Flipkart", 40, 24, 200);
        calculateTotalWage("BigBazar", 20, 22, 150);
        calculateTotalWage("D-mart", 20, 20, 100);
    }
}